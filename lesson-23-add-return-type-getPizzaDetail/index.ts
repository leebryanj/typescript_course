...
// Adding return type : Pizza | undefined doesn't change the way TypeScript sees the code, but it does help us. If, in the future we change the code, we need to either continue returning Pizza or undefined. Or, we need to explicitly change the return type and change our code everywhere else.
